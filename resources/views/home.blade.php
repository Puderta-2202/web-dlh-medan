...
@section('description', 'Dinas Lingkungan Hidup Kota Medan melayani masyarakat dalam pengelolaan dan perlindungan
lingkungan hidup untuk mewujudkan Kota Medan yang bersih, hijau, dan berkelanjutan.')
...
<section id="home" class="relative min-h-screen flex items-center overflow-hidden">
    ...
    <div class="absolute inset-0 bg-gradient-to-br from-orange-50 via-red-50 to-yellow-50">
        ...
        <!-- Floating Elements -->
        <div
            class="absolute top-20 left-10 w-72 h-72 bg-gradient-to-br from-orange-400/20 to-red-400/20 rounded-full blur-3xl animate-pulse">
        </div>
        <div
            class="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-br from-red-400/20 to-yellow-400/20 rounded-full blur-3xl animate-pulse">
        </div>
        <div
            class="absolute top-1/2 left-1/2 w-64 h-64 bg-gradient-to-br from-yellow-400/20 to-orange-400/20 rounded-full blur-3xl animate-pulse">
        </div>
    </div>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="space-y-8 z-10">
                <div class="space-y-6">
                    <div
                        class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-orange-100 to-red-100 rounded-full border border-orange-200/50 backdrop-blur-sm">
                    ...
                    <h1 class="text-5xl lg:text-7xl leading-tight">
                        <span
                            class="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 bg-clip-text text-transparent">
                            Dinas Lingkungan Hidup
                        </span>
                        <br />
                        <span
                            class="bg-gradient-to-r from-orange-600 via-red-500 to-yellow-600 bg-clip-text text-transparent">
                            Kota Medan
                        </span>
                    </h1>
                    ...
                    <p class="text-xl text-gray-600 leading-relaxed max-w-xl">
                        ...
                        untuk mewujudkan Kota Medan yang <span class="text-orange-600 font-semibold">bersih, hijau, dan
                            berkelanjutan</span>.
                    </p>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="#services"
                        ...
                        <i data-lucide="arrow-right"
                            class="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform duration-300"></i>
                    </a>
                    <a href="#contact"
                ...
                <div class="grid grid-cols-3 gap-8 pt-8">
                    ...
                    <div class="text-center group">
                        <div
                            class="w-16 h-16 mx-auto rounded-2xl bg-gradient-to-br {{ $stat['color'] }} p-4 mb-3 shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-110">
            ...
            <div class="relative z-10">
                <div class="relative group">
                    <!-- Glowing backdrop -->
                    <div
                        class="absolute -inset-4 bg-gradient-to-r from-orange-400 via-red-400 to-yellow-400 rounded-3xl blur-2xl opacity-20 group-hover:opacity-30 transition-opacity duration-500">
                    </div>

                    <!-- Main image container -->
                    <div
                        class="relative bg-white/10 backdrop-blur-lg rounded-3xl p-2 border border-white/20 shadow-2xl">
                        <img src="{{ asset('asset/Images/halo.png') }}" alt="Lingkungan Hidup Medan"
                            class="rounded-2xl shadow-xl w-full h-96 object-cover group-hover:scale-105 transition-transform duration-700" />

                        <!-- Overlay gradient -->
                        <div class="absolute inset-2 bg-gradient-to-t from-orange-900/20 to-transparent rounded-2xl">
                        </div>
