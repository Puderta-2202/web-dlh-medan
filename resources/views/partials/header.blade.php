        ...
        <div class="flex justify-between items-center py-3">
            ...
            <nav class="hidden md:flex space-x-1">
                <a href="{{ route('home') }}#home"
                    ...
                    Beranda
                    <span
                        class="absolute inset-x-0 bottom-0 h-0.5 bg-gradient-to-r from-orange-500 to-red-500 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 rounded-full"></span>
                </a>
            ...
            <button id="mobile-menu-button"
                class="md:hidden hover:bg-orange-50/50 transition-colors duration-300 p-2 rounded-lg">
